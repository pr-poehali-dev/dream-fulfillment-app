    ...
    >
          ...
          {[0, 45, 90, 135].map((rot) => (
            <div
              ...
              style={{
                ...
                marginTop: `-${s * 0.7}px`,
                background:
                  "linear-gradient(to bottom, transparent, rgba(255,220,80,0.7), transparent)",
      ...
      {cfg.goldHalo && (
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(255,220,50,0.18) 0%, transparent 70%)",
            pointerEvents: "none",
      ...
      <div
        style={{
          ...
          opacity: cfg.opacity,
          transition:
            "width 0.3s ease, height 0.3s ease, box-shadow 0.3s ease, opacity 0.3s ease",
          border:
            wish.category === "sun"
              ? "2px solid rgba(255,220,80,0.8)"
              : wish.category === "beacon"
                ? "1.5px solid rgba(255,220,120,0.5)"
