    ...
    <>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                num: "III",
                title: "Жди Ангела",
                text: "Ангел или Альтруист увидит твою звезду и исполнит желание. Белая звезда ждёт — красная уже исполнена.",
              },
            ].map((step, i) => (
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-1 mb-3">
          {[ИП ХАБИБУЛЛИН Р.Р. "ИНН 027411103939", "ОГРН 317028000155545"].map((r) => (
            <span
              key={r}
              className="font-golos text-xs"
              style={{ color: "#ffffff" }}
