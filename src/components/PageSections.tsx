      ...
      <section className="relative z-10 py-10 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p
            ...
            style={{ color: "rgba(200,210,240,0.5)" }}
          >
            Каждая звезда — это рекламное место. Разместите информацию о своём
            сайте, товаре или услуге. Мы показываем звёзды в эфирах и отчётах,
            переходим по ссылкам и рассказываем о владельцах.
          </p>
        </div>
      </section>
