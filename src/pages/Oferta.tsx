      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        >
          ...
          >
            ...
            zagadai.online загорается виртуальная звезда, которая занимает
            конкретное место на небосводе и закрепляется за Заказчиком как его
            цифровая собственность (виртуальный цифровой актив, не являющийся
            магическим или экстрасенсорным), с которой связывается желание
            Заказчика.
            <br />
          ...
          <p
            ...
            style={{ color: "rgba(200,210,240,0.6)" }}
          >
            3.1. Исполнитель обязан: обеспечить активацию виртуальной звезды на
            Сайте после получения подтверждения успешной оплаты.
            <br />
          ...
          <h2
            ...
            style={{ color: "#c9a84c" }}
          >
            7. Срок действия платформы
          </h2>
          <p
            className="font-golos text-sm leading-relaxed mb-4"
            style={{ color: "rgba(200,210,240,0.6)" }}
          >
            Платформа zagadai.online предоставляет услугу «Зажжение звезды» в
            момент оплаты. Услуга считается полностью оказанной после активации
            звезды на небосводе. Дальнейшее существование звезды на сайте не
            гарантируется на неопределённый срок и зависит от технической и
            коммерческой целесообразности поддержания платформы. В случае
            закрытия проекта обязательства Исполнителя перед Заказчиком
            считаются выполненными в полном объёме, так как услуга была оказана
            в момент активации звезды.
          </p>
        </div>
