...
# "колодец + море" зафиксирована по высоте (46vh) и прижата к низу — то
# есть видимая линия горизонта стабильно держится около 50-56% высоты
# на любом устройстве. Луна — отдельная картинка в правом верхнем углу
# (top 4%, right 4%, ширина до ~32% меньшей стороны экрана).
STAR_ZONE_X_MIN, STAR_ZONE_X_MAX = 3.0, 97.0
STAR_ZONE_Y_MIN, STAR_ZONE_Y_MAX = 6.0, 48.0
MOON_NOTCH_X_MIN, MOON_NOTCH_X_MAX = 62.0, 100.0
MOON_NOTCH_Y_MAX = 34.0
